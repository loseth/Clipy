...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KeyHolder",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9KeyHolder10RecordView")
@interface RecordView : NSView
@property (nonatomic, strong) IBInspectable NSColor * _Nonnull backgroundColor;
@property (nonatomic, strong) IBInspectable NSColor * _Nonnull tintColor;
...
- (BOOL)performKeyEquivalent:(NSEvent * _Nonnull)theEvent SWIFT_WARN_UNUSED_RESULT;
...
@interface RecordView (SWIFT_EXTENSION(KeyHolder))
